...
driver.get(best)
sleep(3)
driver.find_element_by_xpath("//input[contains(@name, 'username')]")\
                    .send_keys(usr)
driver.find_element_by_xpath("//input[contains(@name, 'password')]")\
                    .send_keys(passwd)
driver.find_element_by_xpath("//button[contains(@class, 'btn btn-primary')]")\
                    .click()
